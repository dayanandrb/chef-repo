...
default['confluence']['apache2']['access_log']         = '/var/atlassian/application-data/confluence/logs'
default['confluence']['apache2']['error_log']          = '/var/atlassian/application-data/confluence/error_log'
